...
h = 1 # set h = 1 for replication of nowcast task
...
for(ndim in 3:3){
  ...
  save(res,file = paste0("output/",0,"/CPI_nowcast_PositiveLink",ndim,"_lambda=",lambda_0,"_lambda1=",lambda_1,"_lambda3=",lambda_2_base,"_h=",h,"_lag_",use_lag,".rda"))
  ...
  save(final_res,file = paste0("output/",0,"/CPI_nowcast_PositiveLink",ndim,"_lambda=",lambda_0,"_lambda1=",lambda_1,"_lambda3=",lambda_2_base,"_h=",h,"_final_selection_lag_",use_lag,".rda"))
}
